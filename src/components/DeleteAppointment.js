          ...
          <ul className="mt-5 space-y-4">
            {appointments.map((appointment) => (
              <li key={appointment._id} className="rounded-md shadow-sm">
                <button
                  className="w-full flex flex-col items-center justify-center px-4 py-1 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 focus:outline-none transition duration-500 ease-in-out transform hover:scale-105"
                  onClick={() =>
                    setSelectedUser(
